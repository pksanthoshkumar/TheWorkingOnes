...
public class Room 
{
    ...
    private static boolean isRandomRoom; //all room's have the ability to become the random room teleported to
    ...
    {
        if(items.isEmpty()){
            String returnString = "You are " + description + ", there are no items in this room";
            returnString += ".\n" + getExitString();
            return returnString;
        }
        ...
        for(Item item:items){
            ...
            returnString += " "+ item.itemDescription();
        }
