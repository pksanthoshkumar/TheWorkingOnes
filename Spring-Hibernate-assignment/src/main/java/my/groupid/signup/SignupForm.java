...
public class SignupForm {
	...
	private static final String EMAIL_VALID_RBC_DOMAIN_MESSAGE = "{email.invalid-rbc-domain-message}";	

    @NotBlank(message = SignupForm.NOT_BLANK_MESSAGE)
	@Email(message = SignupForm.EMAIL_MESSAGE)
	@EmailExists(message = SignupForm.EMAIL_EXISTS_MESSAGE)
    @RbcDomainEmail(message = SignupForm.EMAIL_VALID_RBC_DOMAIN_MESSAGE)
